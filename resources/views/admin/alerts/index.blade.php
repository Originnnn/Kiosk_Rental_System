...
<div class="bg-slate-50 min-h-screen p-6 font-sans">
    ...
    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-6 min-h-[40px]">
        <div class="flex-1">
            <h1 class="text-2xl font-bold text-slate-800 leading-tight">Cảnh báo hệ thống</h1>
            <p class="text-sm text-slate-500 mt-1">Giám sát các vấn đề cần xử lý khẩn cấp.</p>
        </div>
